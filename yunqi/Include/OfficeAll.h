...
struct __declspec(uuid("0cdbe87c-86ed-406b-aea1-f6f68151bf4f")) IDUIBookViewer;
struct __declspec(uuid("0c8f95af-9b01-4414-a378-b300cb5d45b2")) DUIBookViewer;
struct __declspec(uuid("bada0fee-18f9-43e3-860d-09c7de8a3fc0")) _IDUIBookViewerEvents;
...
enum DUIOUTBAR_NOTIFY
{ 
	DUIOUTBAR_FOLDERCHANGE = 3058,
	DUIOUTBAR_HITITEM = 3056,
	DUIOUTBAR_RBUTTONDOWN = 3057 
};
...
struct __declspec(uuid("88a3196a-3223-4f58-874b-5d6fc4b7d74e")) IDUISimpleTree : IDUIControlBase
{
	...
	virtual HRESULT __stdcall raw_GetItemModel(OLE_HANDLE hItem, struct IDUIControlBase **pResult) = 0;
	...
	struct IDUIControlBase * GetItemModel(OLE_HANDLE  hItem  );
};
...
struct __declspec(uuid("bada0fee-18f9-43e3-860d-09c7de8a3fc0")) _IDUIBookViewerEvents : IDispatch
{
	//
	//Property
	//
...
struct __declspec(uuid("0cdbe87c-86ed-406b-aea1-f6f68151bf4f")) IDUIBookViewer : IDUIControlBase
{
	//
	//Property
	//
	...
	//Method
	//
	virtual HRESULT __stdcall raw_SetContent(BSTR strContent, VARIANT_BOOL *bResult  ) = 0;
	virtual HRESULT __stdcall raw_GetTotalPage(long *pResult) = 0;
	virtual HRESULT __stdcall raw_SetCurPage(long nCurPage, VARIANT_BOOL *bResult  ) = 0;
	virtual HRESULT __stdcall raw_GetCurPage(long *pResult) = 0;

	//
	//Method Wrapper
	//
	void SetContent(tstring  strContent, VARIANT_BOOL * bResult  );
	long  GetTotalPage();
	void SetCurPage(long  nCurPage, VARIANT_BOOL * bResult  );
	long  GetCurPage();
};
