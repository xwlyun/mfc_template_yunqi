...
struct __declspec(uuid("6e6f7ca2-a673-4d9d-9011-d73a19fe4cbe")) DUI_COLORCASE;
enum DUI_DRAG_MODE;

struct __declspec(uuid("b553b4fb-bb57-4ae1-9e57-9bf2a3aa7ec7")) DUI_USERDATA;
...
{ 
	...
	DUISM_MOUSEENTERCTRL = 1925,
	DUISM_MOUSELEAVE = 1863,
	DUISM_MOUSELEAVECTRL = 1926,
	DUISM_MOUSEMOVE = 1861,
	DUISM_NEEDSCROLLBAR = 1912,
	DUISM_NOTIFYCHILDREN = 1864,
	DUISM_ONKILLFOCUS = 3034,
	DUISM_ONSETFOCUS = 3033,
	DUISM_POST_DODRAGDROP = 1921,
	DUISM_PRE_DODRAGDROP = 1913,
...
struct __declspec(uuid("936c7adf-65af-4807-8434-474243ddeb26")) ISkinObjResBase : IDUIObj
{
	...
	virtual HRESULT __stdcall raw_SetCtrlState(enum DUI_CTRLSTATE nCtrlState  ) = 0;
	virtual HRESULT __stdcall raw_GetCtrlState(enum DUI_CTRLSTATE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetVisibleEx(VARIANT_BOOL bVisible, VARIANT_BOOL bRefresh, VARIANT_BOOL bAnimate  ) = 0;
	virtual HRESULT __stdcall raw_MoveBottom(struct ISkinObjResBase *pSubObj, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_MirrorObject(VARIANT_BOOL bMirrorObj  ) = 0;
	virtual HRESULT __stdcall raw_IsMirrorObject(VARIANT_BOOL *pResult) = 0;
	...
	void SetCtrlState(enum DUI_CTRLSTATE  nCtrlState  );
	enum DUI_CTRLSTATE  GetCtrlState();
	void SetVisibleEx(BOOL  bVisible, BOOL  bRefresh, BOOL  bAnimate  );
	BOOL  MoveBottom(struct ISkinObjResBase * pSubObj  );
	void MirrorObject(BOOL  bMirrorObj  );
	BOOL  IsMirrorObject();
};
...
struct __declspec(uuid("f0a6b880-d1d3-4f9e-9e06-ba340130a26d")) IDUIRes : IDispatch
{
	...
	virtual HRESULT __stdcall raw_GetColorCaseCount(long *pResult) = 0;
	virtual HRESULT __stdcall raw_GetCurColorCaseName(BSTR *pResult) = 0;
	virtual HRESULT __stdcall raw_SetCurColorCase(BSTR strName, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_GetCurColorCase(struct DUI_COLORCASE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetColorCase(BSTR strName, struct DUI_COLORCASE *pResult) = 0;
	virtual HRESULT __stdcall raw_AddColorCase(BSTR strName, struct DUI_COLORCASE *pResult  ) = 0;
	virtual HRESULT __stdcall raw_RemoveColorCase(BSTR strName, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_GetFirstColorCase(struct DUI_COLORCASE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetNextColorCase(struct DUI_COLORCASE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetSkinEncryptPassword(BSTR strPassword  ) = 0;
	virtual HRESULT __stdcall raw_ReleaseSkin(VARIANT_BOOL *pResult) = 0;
	...
	long  GetColorCaseCount();
	tstring  GetCurColorCaseName();
	BOOL  SetCurColorCase(tstring  strName  );
	struct DUI_COLORCASE  GetCurColorCase();
	struct DUI_COLORCASE  GetColorCase(tstring  strName  );
	void AddColorCase(tstring  strName, struct DUI_COLORCASE * pResult  );
	BOOL  RemoveColorCase(tstring  strName  );
	struct DUI_COLORCASE  GetFirstColorCase();
	struct DUI_COLORCASE  GetNextColorCase();
	void SetSkinEncryptPassword(tstring  strPassword  );
	BOOL  ReleaseSkin();
};
...
struct __declspec(uuid("be88233e-f480-47e1-846d-39652e124e9e")) ILayerGraphics : IDispatch
{
	...
	//Method
	//
	virtual HRESULT __stdcall raw_Create(struct SkinRect sknrc, VARIANT_BOOL *pResult) = 0;
	...
	//Method Wrapper
	//
	BOOL  Create(struct SkinRect  sknrc  );
	OLE_HANDLE  GetDC();
	void Destroy();
...
struct __declspec(uuid("b3ad51eb-77be-44d4-959e-2244ab8c5718")) IDUIRenderDC : IDispatch
{
	...
	virtual HRESULT __stdcall raw_DrawLine(short x1, short y1, short x2, short y2, short nPenSize, short nAlpha, OLE_COLOR clrSolid, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_SetViewport(struct SkinRect srcRect  ) = 0;
	virtual HRESULT __stdcall raw_GetViewport(struct SkinRect *pResult) = 0;
	virtual HRESULT __stdcall raw_GetRenderDevice(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetDC(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetType(long *pResult) = 0;
	virtual HRESULT __stdcall raw_SetCurrentControl(struct IDUIControlBase *pControlBase  ) = 0;
	virtual HRESULT __stdcall raw_GetCurrentControl(struct IDUIControlBase **pResult) = 0;
	virtual HRESULT __stdcall raw_GetHDCNoAlpha(long nWidht, long nHeight, OLE_HANDLE *pResult) = 0;
	...
	BOOL  DrawLine(short  x1, short  y1, short  x2, short  y2, short  nPenSize, short  nAlpha, OLE_COLOR  clrSolid  );
	...
	void SetViewport(struct SkinRect  srcRect  );
	struct SkinRect  GetViewport();
	OLE_HANDLE  GetRenderDevice();
	OLE_HANDLE  GetDC();
	long  GetType();
	void SetCurrentControl(struct IDUIControlBase * pControlBase  );
	struct IDUIControlBase * GetCurrentControl();
	OLE_HANDLE  GetHDCNoAlpha(long  nWidht, long  nHeight  );
};
...
struct __declspec(uuid("533b8057-9b33-4c2a-b643-35cc61df5e33")) IDUIRenderImage : IDispatch
{
	...
	virtual HRESULT __stdcall raw_SetBlurSize(long nSize  ) = 0;
	virtual HRESULT __stdcall raw_GetBlurSize(long *pResult) = 0;
...
struct __declspec(uuid("b143f497-cdec-4a2f-b903-530228d4bdb1")) IDUIControlBase : ISkinObjResBase
{
	...
	virtual HRESULT __stdcall raw_ShiftFocus() = 0;
	virtual HRESULT __stdcall raw_GetDUIRenderDC(struct IDUIRenderDC **pResult) = 0;
	virtual HRESULT __stdcall raw_RenderDrawFocus(struct IDUIRenderDC *pDC  ) = 0;
	virtual HRESULT __stdcall raw_IsFocus(VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_KillFocus() = 0;
	virtual HRESULT __stdcall raw_CloneProp(struct IDUIControlBase *pSrcDisp  ) = 0;
	virtual HRESULT __stdcall raw_GetProps(OLE_HANDLE **pResult) = 0;
	virtual HRESULT __stdcall raw_SetDisposeMouse(VARIANT_BOOL bDisposemouse  ) = 0;
	virtual HRESULT __stdcall raw_AddFillColor(struct IFillColor *prop, struct SkinRect rc  ) = 0;
	virtual HRESULT __stdcall raw_AddImageBase(struct IDUIImageBase *prop, struct SkinRect rc, short idx  ) = 0;
	virtual HRESULT __stdcall raw_AddTextStyle(struct IDUITextStyle *prop, struct SkinRect rc, BSTR text  ) = 0;
	virtual HRESULT __stdcall raw_Update() = 0;
	virtual HRESULT __stdcall raw_Reset() = 0;
	virtual HRESULT __stdcall raw_AddRenderImage(struct IDUIRenderImage *image, struct SkinRect rc, struct SkinRect src, VARIANT_BOOL bStretch, OLE_COLOR clrTrans  ) = 0;
	virtual HRESULT __stdcall raw_AddSolidColor(struct IColorProp *prop, struct SkinRect rc  ) = 0;
	virtual HRESULT __stdcall raw_OnMouseEnterEx(short nHitTest, short x, short y, long *pResult) = 0;
	virtual HRESULT __stdcall raw_OnMouseLeaveEx(short nHitTest, short x, short y, long *pResult) = 0;
	...
	void ShiftFocus();
	struct IDUIRenderDC * GetDUIRenderDC();
	void RenderDrawFocus(struct IDUIRenderDC * pDC  );
	BOOL  IsFocus();
	void KillFocus();
	void CloneProp(struct IDUIControlBase * pSrcDisp  );
	OLE_HANDLE * GetProps();
	void SetDisposeMouse(BOOL  bDisposemouse  );
	void AddFillColor(struct IFillColor * prop, struct SkinRect  rc  );
	void AddImageBase(struct IDUIImageBase * prop, struct SkinRect  rc, short  idx  );
	void AddTextStyle(struct IDUITextStyle * prop, struct SkinRect  rc, tstring  text  );
	void Update();
	void Reset();
	void AddRenderImage(struct IDUIRenderImage * image, struct SkinRect  rc, struct SkinRect  src, BOOL  bStretch, OLE_COLOR  clrTrans  );
	void AddSolidColor(struct IColorProp * prop, struct SkinRect  rc  );
	long  OnMouseEnterEx(short  nHitTest, short  x, short  y  );
	long  OnMouseLeaveEx(short  nHitTest, short  x, short  y  );
};
...
struct __declspec(uuid("86d01378-75ad-42fc-8f3b-99f796d89a18")) IDUIObjectDraw : IDispatch
{
	...
	//Method
	//
	virtual HRESULT __stdcall raw_BeginDraw(OLE_HANDLE hDC, struct ISkinObjResBase *pObject, VARIANT_BOOL bDrawCurrent, VARIANT_BOOL bMemDC  ) = 0;
	...
	//Method Wrapper
	//
	void BeginDraw(OLE_HANDLE  hDC, struct ISkinObjResBase * pObject, BOOL  bDrawCurrent, BOOL  bMemDC  );
	void EndDraw();
...
struct __declspec(uuid("118c0877-b832-4c18-bfbf-7a112483b6af")) IDUITextStyle : ISkinShareBase
{
	...
	virtual HRESULT __stdcall raw_CalcTextWidth(OLE_HANDLE hDC, BSTR strText, long *pResult) = 0;
	virtual HRESULT __stdcall raw_CalcTextSize(OLE_HANDLE hDC, BSTR strText, VARIANT_BOOL bGetWidth, long *pResult) = 0;
	...
	long  CalcTextWidth(OLE_HANDLE  hDC, tstring  strText  );
	long  CalcTextSize(OLE_HANDLE  hDC, tstring  strText, BOOL  bGetWidth  );
};
...
struct __declspec(uuid("47ac6577-d600-49b8-a0bb-ae14897769cd")) IDUIFontEx : ISkinShareBase
{
	...
	virtual HRESULT __stdcall raw_SetLogFont(struct DUILOGFONT pLogFont  ) = 0;
	...
	OLE_HANDLE  GetHFont();
	void SetLogFont(struct DUILOGFONT  pLogFont  );
};
...
struct __declspec(uuid("fe75c13a-e145-49e1-a146-de46f7c40f38")) IColorProp : IDUIPropBase
{
	...
	virtual HRESULT __stdcall raw_Draw(OLE_HANDLE hDC, struct SkinRect rect, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_RenderDraw(struct IDUIRenderDC *pDC, struct SkinRect rect, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_DrawArcTickLine(struct IDUIRenderDC *pDC, struct SkinRect rcDes, float fRadius, float fStatrAngle, float fEndAngle, float fTickAngle, float fLineLen, float fLineWidth, unsigned long clrSolid, float fRotateAngle, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_DrawArc(struct IDUIRenderDC *pDC, struct SkinRect rcDes, float fRadius, float fStartAngle, float fEndAngle, float fRotateAngle, int nPenSize, OLE_COLOR lrSolid, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_DrawArcTickString(struct IDUIRenderDC *pDC, struct SkinRect rcDes, float fRadius, float fStatrAngle, float fEndAngle, float fTickAngle, float fLineLen, float fMinVal, float fFrequency, OLE_HANDLE hFont, long bShowHalfTag, OLE_COLOR clrSolid, float fRotateAngle, VARIANT_BOOL *pResult) = 0;
	...
	BOOL  Draw(OLE_HANDLE  hDC, struct SkinRect  rect  );
	BOOL  RenderDraw(struct IDUIRenderDC * pDC, struct SkinRect  rect  );
	BOOL  DrawArcTickLine(struct IDUIRenderDC * pDC, struct SkinRect  rcDes, float  fRadius, float  fStatrAngle, float  fEndAngle, float  fTickAngle, float  fLineLen, float  fLineWidth, unsigned long  clrSolid, float  fRotateAngle  );
	BOOL  DrawArc(struct IDUIRenderDC * pDC, struct SkinRect  rcDes, float  fRadius, float  fStartAngle, float  fEndAngle, float  fRotateAngle, int  nPenSize, OLE_COLOR  lrSolid  );
	BOOL  DrawArcTickString(struct IDUIRenderDC * pDC, struct SkinRect  rcDes, float  fRadius, float  fStatrAngle, float  fEndAngle, float  fTickAngle, float  fLineLen, float  fMinVal, float  fFrequency, OLE_HANDLE  hFont, long  bShowHalfTag, OLE_COLOR  clrSolid, float  fRotateAngle  );
...
struct __declspec(uuid("9b840c4f-b2e8-46a7-9d04-8f0571adec3a")) IDUIWindow : IDispatch
{
	...
	virtual HRESULT __stdcall raw_OutPutString(BSTR strOut  ) = 0;
	...
	void OutPutString(tstring  strOut  );
};
...
struct __declspec(uuid("892b86ac-044b-42c8-bdaf-9a6723398b53")) DUI_DRAGINFO
{
	...
	struct DUI_USERDATA *	pUserData;
	unsigned int 	hTargetItem;
	VARIANT_BOOL 	bNeedNewHWND;
	enum DUI_DRAG_MODE 	eDragMode;
};

struct __declspec(uuid("b553b4fb-bb57-4ae1-9e57-9bf2a3aa7ec7")) DUI_USERDATA
{
	long 	lType;
	unsigned int 	hUserData;
};
...
struct __declspec(uuid("600b0bdd-2ece-4e36-a349-456c7be9440f")) IDirectUI : ISkinObjResBase
{
	...
	virtual HRESULT __stdcall raw_FreezeUpdate(VARIANT_BOOL bFreeze  ) = 0;
	virtual HRESULT __stdcall raw_IsFreezeUpdate(VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_GetFreezeHBitmap(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetFreezeDrawRect(struct SkinRect rc  ) = 0;
	virtual HRESULT __stdcall raw_RegSyncMoveWindow(OLE_HANDLE hWnd, struct IDUIControlBase *pCtrl  ) = 0;
	virtual HRESULT __stdcall raw_AppendFinalCtrl(struct ISkinObjResBase *pContrlBase  ) = 0;
	virtual HRESULT __stdcall raw_RemoveFinalCtrl(struct ISkinObjResBase *pContrlBase  ) = 0;
	virtual HRESULT __stdcall raw_UnRegSyncMoveWindow(OLE_HANDLE hWnd  ) = 0;
	virtual HRESULT __stdcall raw_SetArabicMode(VARIANT_BOOL bIsMirror  ) = 0;
	virtual HRESULT __stdcall raw_RegisterHotkey(VARIANT_BOOL bRegister  ) = 0;
	virtual HRESULT __stdcall raw_IsRegisterHotkey(VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_ShiftFocus(VARIANT_BOOL bForward  ) = 0;
	virtual HRESULT __stdcall raw_SynMoveWindow() = 0;
	virtual HRESULT __stdcall raw_GetDUIControlByPt(long nXPt, long nYPt, struct ISkinObjResBase **pResult) = 0;
	virtual HRESULT __stdcall raw_SetCaptureCtrl(struct IDUIControlBase *pCtrl  ) = 0;
	virtual HRESULT __stdcall raw_ReleaseCaptureCtrl() = 0;
	virtual HRESULT __stdcall raw_DirectDrawImmediate() = 0;
	virtual HRESULT __stdcall raw_FadeShow(VARIANT_BOOL bShow, enum DUI_FADE_TYPE FadeType  ) = 0;
	virtual HRESULT __stdcall raw_ReCalcRgn() = 0;
	virtual HRESULT __stdcall raw_IsDraging(VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_RegisterDropTarget(OLE_HANDLE hWnd, OLE_HANDLE dwMode  ) = 0;
	virtual HRESULT __stdcall raw_RevokeDropTarget(OLE_HANDLE hWnd  ) = 0;
	virtual HRESULT __stdcall raw_RotateWindow(enum DUI_ROTATE_TYPE eType, float fAngle  ) = 0;
	virtual HRESULT __stdcall raw_InitRotateWindow() = 0;
	virtual HRESULT __stdcall raw_EndRotateWindow() = 0;
	virtual HRESULT __stdcall raw_AddDirtyRect(struct SkinRect rc  ) = 0;
	virtual HRESULT __stdcall raw_Present(struct SkinRect *pResult) = 0;
	virtual HRESULT __stdcall raw_IsBatchMode(VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_SetBatchMode(VARIANT_BOOL bValue  ) = 0;
	virtual HRESULT __stdcall raw_GetCurrentFocusObject(struct ISkinObjResBase **pResult) = 0;
	virtual HRESULT __stdcall raw_RegisterAcceptFile(struct IDUIControlBase *pCtrl, long nMode  ) = 0;
	virtual HRESULT __stdcall raw_RevokeAcceptFile(struct IDUIControlBase *pCtrl  ) = 0;
	virtual HRESULT __stdcall raw_CancelDrag() = 0;
	virtual HRESULT __stdcall raw_SetHotCtrl(struct IDUIControlBase *pCtrl  ) = 0;
	virtual HRESULT __stdcall raw_GetHotCtrl(struct ISkinObjResBase **pResult) = 0;
	...
	void FreezeUpdate(BOOL  bFreeze  );
	BOOL  IsFreezeUpdate();
	OLE_HANDLE  GetFreezeHBitmap();
	void SetFreezeDrawRect(struct SkinRect  rc  );
	void RegSyncMoveWindow(OLE_HANDLE  hWnd, struct IDUIControlBase * pCtrl  );
	void AppendFinalCtrl(struct ISkinObjResBase * pContrlBase  );
	void RemoveFinalCtrl(struct ISkinObjResBase * pContrlBase  );
	void UnRegSyncMoveWindow(OLE_HANDLE  hWnd  );
	void SetArabicMode(BOOL  bIsMirror  );
	void RegisterHotkey(BOOL  bRegister  );
	BOOL  IsRegisterHotkey();
	void ShiftFocus(BOOL  bForward  );
	void SynMoveWindow();
	struct ISkinObjResBase * GetDUIControlByPt(long  nXPt, long  nYPt  );
	void SetCaptureCtrl(struct IDUIControlBase * pCtrl  );
	void ReleaseCaptureCtrl();
	void DirectDrawImmediate();
	void FadeShow(BOOL  bShow, enum DUI_FADE_TYPE  FadeType  );
	void ReCalcRgn();
	BOOL  IsDraging();
	void RegisterDropTarget(OLE_HANDLE  hWnd = 0, OLE_HANDLE  dwMode = 1  );
	void RevokeDropTarget(OLE_HANDLE  hWnd = 0  );
	void RotateWindow(enum DUI_ROTATE_TYPE  eType, float  fAngle  );
	void InitRotateWindow();
	void EndRotateWindow();
	void AddDirtyRect(struct SkinRect  rc  );
	struct SkinRect  Present();
	BOOL  IsBatchMode();
	void SetBatchMode(BOOL  bValue  );
	struct ISkinObjResBase * GetCurrentFocusObject();
	void RegisterAcceptFile(struct IDUIControlBase * pCtrl, long  nMode = 1  );
	void RevokeAcceptFile(struct IDUIControlBase * pCtrl  );
	void CancelDrag();
	void SetHotCtrl(struct IDUIControlBase * pCtrl  );
	struct ISkinObjResBase * GetHotCtrl();
};
...
struct __declspec(uuid("aadcc987-5067-44ea-a536-4df0ef31e2f3")) ITextStyleProp : IDUIPropBase
{
	...
	virtual HRESULT __stdcall raw_GetTextRenderHint(short *pResult) = 0;
...
struct __declspec(uuid("79811451-25bd-4717-8739-c1055edbc9aa")) IScriptUtils : IDispatch
{
	...
	virtual HRESULT __stdcall raw_NewResource(BSTR strSkinName, BSTR strDui, BSTR strSkn  ) = 0;
	virtual HRESULT __stdcall raw_CreateDirectuiWnd(BSTR strName, OLE_HANDLE hWndParent, struct IDUIRes *pDUIRes  ) = 0;
	virtual HRESULT __stdcall raw_GetDirectUI(BSTR strName, OLE_HANDLE hParentWnd  ) = 0;
	virtual HRESULT __stdcall raw_AddScriptRef(IDispatch *pDispatch  ) = 0;
	virtual HRESULT __stdcall raw_GetBitmap(BSTR strFileName, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_DeleteBitmap(OLE_HANDLE pBitmap  ) = 0;
	...
	void NewResource(tstring  strSkinName, tstring  strDui, tstring  strSkn  );
	void CreateDirectuiWnd(tstring  strName, OLE_HANDLE  hWndParent, struct IDUIRes * pDUIRes  );
	void GetDirectUI(tstring  strName, OLE_HANDLE  hParentWnd  );
	void AddScriptRef(IDispatch * pDispatch  );
	OLE_HANDLE  GetBitmap(tstring  strFileName  );
	void DeleteBitmap(OLE_HANDLE  pBitmap  );
};
