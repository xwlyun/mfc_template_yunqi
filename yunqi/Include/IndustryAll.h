...
struct __declspec(uuid("22590266-e34f-48a4-83ab-80393a3ef811")) IDUIGraphicLine;
...
struct __declspec(uuid("22590266-e34f-48a4-83ab-80393a3ef811")) IDUIGraphicLine : IDUIControlBase
{
	//
	//Property
	//
